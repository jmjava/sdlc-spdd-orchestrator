...
5. Generate a shell script under `scripts/` or `sdlc-spdd/spdd/tasks/` (team convention) with:
...
- `sdlc-spdd/spdd/tasks/<WORK-ID>-api-test.sh` (or `scripts/test-api-<WORK-ID>.sh` when clearer)
