...
- A requirement document (`sdlc-spdd/requirements/`, `sdlc-spdd/requirements/milestones/`, or
  `sdlc-spdd/requirements/milestones/milestone-N/<WORK-ID>.md`)
- A user story or milestone item
- `sdlc-spdd/ROADMAP.md`, root `milestone-*.md`, or
  `sdlc-spdd/requirements/milestones/milestone-N/MILESTONE-N.md`
...
1. Gate first: run `./sdlc-spdd/scripts/sdlc.sh gate analysis --work-id <WORK-ID>` (in the
...
2. **Read the requirement document** — Prefer
   `sdlc-spdd/requirements/milestones/<WORK-ID>.md` or
   `sdlc-spdd/requirements/milestones/milestone-N/<WORK-ID>.md`. Extract declared scope
...
11. After writing the analysis file, run
    `./sdlc-spdd/scripts/index-spdd-analysis.sh <WORK-ID>`
...
- `sdlc-spdd/spdd/analysis/<WORK-ID>-analysis.md` (canonical)
...
(`/sdlc-spdd-plan @sdlc-spdd/spdd/analysis/<WORK-ID>-analysis.md`).

Guidance: `docs/analysis-phase-scope-validation.md` (installed as
`sdlc-spdd/docs/analysis-phase-scope-validation.md`).
