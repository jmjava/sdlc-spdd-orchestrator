...
1. Gate first: run `./sdlc-spdd/scripts/sdlc.sh gate sync --work-id <WORK-ID>` (in the
...
14. Promote accepted staged lessons with `./sdlc-spdd/scripts/sdlc.sh accept --work-id <ID>`.
...
- `sdlc-spdd/spdd/sync/<WORK-ID>-sync.md`
- Accepted staged lesson records via `./sdlc-spdd/scripts/sdlc.sh accept --work-id <ID>`
