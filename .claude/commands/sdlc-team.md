...
1. Run `./sdlc-spdd/scripts/sdlc.sh team` (or `./scripts/sdlc.sh team` in the orchestrator repo) and present the output as a readable summary.
2. Run `./sdlc-spdd/scripts/sdlc.sh list-work` (or `./scripts/sdlc.sh list-work`) when the user asks what Work IDs exist or the registry is empty.
