...
|---|---------|----------------|-------|--------|
| 1 | DOC-001 (+ SPIKE-004 plan already on PR #219) | `cursor/academic-hardening-review-fdf7` | `./sdlc-spdd/docs/research/prove-p0.sh DOC-001` | pending merge |
| 2 | DOC-002-related-work-map | `cursor/doc-002-related-work-fdf7` | `./sdlc-spdd/docs/research/prove-p0.sh DOC-002` | blocked on #1 |
| 3 | TEST-001-evaluation-protocol | `cursor/test-001-eval-protocol-fdf7` | `./sdlc-spdd/docs/research/prove-p0.sh TEST-001` | blocked on #2 |
