...
| [FEAT-013-guide-git-incremental-upstream](requirements/milestones/FEAT-013-guide-git-incremental-upstream.md) | Fork sustainment for git-incremental + RAG maintenance; **never** PR to `embabel/guide` | In Progress (T02 docs/policy) |
