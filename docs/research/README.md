...
| [Research questions and constructs (DOC-001)](../../sdlc-spdd/docs/research/research-questions-and-constructs.md) | Frozen RQs + construct spec + **academic review goal** | Stores (canvas, ledger, Guide projection); retrievability bar; not reduced-drift; `embabel-dif` later |
