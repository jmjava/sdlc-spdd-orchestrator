...
- [x] Guide lean+legacy context-index load (#89) on `jmjava/guide`  
- [ ] Human review of integration branch + Guide dual-index PR  
- [ ] Then open **one** PR: `cursor/agent-context-cleanup-integration-decf` → `main`  
