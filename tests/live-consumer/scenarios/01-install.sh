...
[[ ! -e "${HOME}/scripts/sdlc-pointer.sh" ]] && ok "no bash pointer twin" || bad "bash pointer twin installed"
[[ ! -e "${HOME}/scripts/sdlc-workflow.sh" ]] && ok "no bash workflow twin" || bad "bash workflow twin installed"
